        ...
        rows.append(
            {
                ...
                "profile_fit_score": item.get("profile_fit_score"),
                "style_lane": item.get("style_lane"),
                "philosophy_evidence_status": item.get("philosophy_evidence_status"),
                "filing_urls": item.get("filing_urls") or [],
                ...
                "fund_value_ratio": item.get("fund_value_ratio"),
